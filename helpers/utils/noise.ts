...
class Noise {
  ...
  simplex3(xin: number, yin: number, zin: number) {
    ...
    const gi1 = this.gradP[i + i1 +this.perm[j + j1 + this.perm[k + k1]]] as Grad
    const gi2 = this.gradP[i + i2 + this.perm[j + j2 + this.perm[k + k2]]] as Grad
  ...
  perlin2(x: number, y: number) {
    ...
    const n11 = (this.gradP[X + 1 + this.perm[Y + 1]] as Grad).dot2(x - 1, y - 1)
  ...
  perlin3(x: number, y: number, z: number) {
    ...
    const n000 = (this.gradP[X + this.perm[Y + this.perm[Z]]] as Grad).dot3(x, y, z)
    const n001 = (this.gradP[X + this.perm[Y + this.perm[Z + 1]]] as Grad).dot3(x, y, z - 1)
    const n010 = (this.gradP[X + this.perm[Y +1 + this.perm[Z]]] as Grad).dot3(x, y - 1, z)
    const n011 = (this.gradP[X + this.perm[Y +1 + this.perm[Z + 1]]] as Grad).dot3(x, y - 1, z - 1)
    const n100 = (this.gradP[X + 1 + this.perm[Y + this.perm[Z]]] as Grad).dot3(x-1, y, z)
    const n101 = (this.gradP[X + 1 + this.perm[Y + this.perm[Z + 1]]] as Grad).dot3(x - 1, y, z - 1)
    const n110 = (this.gradP[X + 1 + this.perm[Y + 1 + this.perm[Z]]] as Grad).dot3(x - 1, y - 1, z)
    const n111 = (this.gradP[X + 1 + this.perm[Y + 1 + this.perm[Z + 1]]] as Grad).dot3(x - 1, y - 1, z - 1)
